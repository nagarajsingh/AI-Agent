...
2. Extract application_name from Product Name, Project Name, Services, document title, or deployment information.
   Examples: OBP, OBTFPM, OBTF, OBDX, OBLM, OBLMIC, OBVAM, OBVAMIC, CMNCORE, MOC, PLATO.

3. Extract branch_name from fields like Branch Name, Profinch Branch, Deployment Steps, or sync branch instruction.

4. Extract repository_name from fields like Repo Name, Repository, or Profinch Repo.

5. Extract environment from fields like Environment, build release, or deployment target.
   Examples: UAT, R2UAT, SIT, RLSIT, T24, PROD.

6. Extract code_base_version from Code Base Version, Release version, or Version.
...
10. For OBTFPM documents, repo name should decide pipeline_application when available:
